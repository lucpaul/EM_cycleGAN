...
class Visualizer():
    ...
    def display_current_results(self, visuals, epoch, save_result):
        ...
        """
        # for valid padding get rid of rec_A and rec_B in the visualisation because they will be too small to view properly
        #if self.opt.model == "cyclegan_valid":
        #    visuals.pop("rec_A")
        #    visuals.pop("rec_B")
        if self.display_id > 0:  # show images in the browser using visdom
            ...
            if ncols > 0:        # show all the images in one visdom panel
                ...
                for label, image in visuals.items():
                    #image_shape = util.tensor2im(image).shape
                    ...
                    if idx % ncols == 0:
                        ...
                        label_html_row = ''
                white_image = (np.ones_like(image_numpy) * 255).astype(np.uint8)
