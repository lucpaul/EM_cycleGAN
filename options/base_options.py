...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--netG", type=str, default="unet_32", help="specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128]"
        )
        ...
        parser.add_argument("--use_amp", action="store_true", help="enable mixed precision (AMP) training (default: False)")
        # dataset parameters
        parser.add_argument(
            "--dataset_mode",
            type=str,
            default="patched_unaligned_2d_zarr",
        ...
        parser.add_argument(
            "--stitch_mode",
            type=str,
            default="tile-and-stitch",
            help='This argument determines how the output data will be stitched, default is tile-and-stitch other options are: "tile-and-stitch", "valid-no-crop", "overlap-average"',
        )

        parser.add_argument("--use_zarr", action="store_true", help="use zarr format for lazy loading, when dataset is too large to fit into memory")
