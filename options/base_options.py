...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='/fast/AG_Kainmueller/data/domain_adaptation/HeLa-NMR', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='experiment_name', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='/fast/AG_Kainmueller/data/domain_adaptation/Models/2D_models/HeLa-NMR', help='models are saved here')
        # model parameters
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='patched_unaligned_new', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
